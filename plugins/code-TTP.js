...
XcriptX.addCommand({pattern: 'll ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tred ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tblue ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tgreen ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tblack ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tyellow ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tpink ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tpurple ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'torange ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'tbrown ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 XcriptX.addCommand({pattern: 'terin ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
