...
if (Config.WORKTYPE == 'private') {
    XcriptX.addCommand({pattern: 'sticker$', fromMe: true, deleteCommand: false, }, (async (message, match) => {    
    ...
    XcriptX.addCommand({pattern: 'sticker$', fromMe: false, deleteCommand: false,}, (async (message, match) => {    
