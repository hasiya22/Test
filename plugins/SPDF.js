...
let td = Config.WORKTYPE == 'public' ? false : true
   ...
   XcriptX.addCommand({pattern: 'spdf ?(.*)', fromMe: td, desc: Lang.SPDF }, (async (message, match) => {
...
XcriptX.addCommand({pattern: 'spdf ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
