...
XcriptX.addCommand({pattern: 'killspam', fromMe: true, dontAddCommandList: true,}, (async (message, match) => {
...
XcriptX.addCommand({pattern: 'spam ?(.*)', fromMe: true, dontAddCommandList: true,}, (async (message, match) => {
