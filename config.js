...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/f8690daae458a451eb9a0.jpg' : process.env.ALIVE_LOGO,
    ...
    MENU_COMMAND: process.env.MENU_COMMAND === undefined ? 'x' : process.env.MENU_COMMAND,
    ...
    MENU_INFO: process.env.MENU_INFO === undefined ?'XTroid-X Most powerful User Bot Powerd by X-Script' : process.env.MENU_INFO,
    BRANCH: 'main',
    HEROKU: {
    ...
    SUPPORT4: "905511384572-1621015274"
};
